...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Alert_the_DTW_Admin_when_Approver_Employment_Status_is_Changed</fullName>
        <description>Alert the DTW Admin when Approver Employment Status is Changed</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>DTW_Project_Incentives/Notify_DTW_Admin_of_Approver_Employment_Change</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        <fullName>Send_Notification_to_PM_when_EA_has_been_Rejected_for_Correction</fullName>
        <description>Send Notification EA PM when Rejected for Correction</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>DTW_Project_Incentives/Notify_Enrollment_Application_Rejection_for_Correction</template>
    </alerts>
    <fieldUpdates>
...
IF(TEXT(IncentivePlan__r.MaxPoolOperator1__c) = &quot;+&quot;, (ForecastNSRBudgetatSnapshot__c + IncentivePlan__r.MaxPoolField12__c), 
IF(TEXT(IncentivePlan__r.MaxPoolOperator1__c) = &quot;-&quot;, (ForecastNSRBudgetatSnapshot__c - IncentivePlan__r.MaxPoolField12__c), 
IF(TEXT(IncentivePlan__r.MaxPoolOperator1__c) = &quot;x&quot;, ROUND((ForecastNSRBudgetatSnapshot__c * IncentivePlan__r.MaxPoolField12__c),1), 
IF(TEXT(IncentivePlan__r.MaxPoolOperator1__c) = &quot;/&quot;, ROUND((ForecastNSRBudgetatSnapshot__c / IncentivePlan__r.MaxPoolField12__c),1),Null) 
))),Null)</formula>
...
IF(TEXT(IncentivePlan__r.MaxPoolOperator2__c) = &quot;/&quot;, ROUND((IncentivePlan__r.MaxPoolField2__c / AdjustedComplete__c),1),Null) 
    ...
    <fieldUpdates>
        ...
        <formula>IncentivePlan__r.MaxPoolField12__c</formula>
    ...
    <fieldUpdates>
        <fullName>Set_Threshold_GM_Snapshot_value</fullName>
        <field>ThresholdGMSnapshot__c</field>
        <formula>ThresholdGM__c</formula>
        <name>Set Threshold GM % Snapshot value</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
        <reevaluateOnChange>true</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Set_Threshold_Snapshot_to_100</fullName>
        <description>Flag to force updated</description>
        <field>ThresholdGMSnapshot__c</field>
        <formula>0</formula>
        <name>Set Threshold Snapshot to 100%</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
 ...
 &quot;Baseline GM % of NSR&quot;, BaselineGMofNSR__c,NULL)</formula>
    ...
    <fieldUpdates>
        ...
        <formula>IncentivePlan__r.ThresholdField2__c</formula>
    ...
    <fieldUpdates>
        <fullName>Threshold_Operator_1</fullName>
        <field>EAThresholdOperator1__c</field>
        <formula>TEXT(IncentivePlan__r.ThresholdOperator1__c)</formula>
        <name>Threshold Operator 1</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        ...
        <actions>
            <name>Set_EA_Status_to_Pending_AP1_Action</name>
...
/*Instead of setting the flag to &quot;Yes&quot; or &quot;No&quot;, change the Exceptions Flag to a Text Field instead, and show the reason (s) why there is an exception */</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <description>Overwrites the FP NSR and DPE adjustment values to match the T&amp;M value for down stream calcs.</description>
    ...
    <rules>
        ...
        <actions>
            <name>Threshold_Operator_1</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>Brings down the Threshold and Max Pool calculations as defined from the Incentive Plan Template  TEXT(EAThresholdField1__c) = &quot;&quot;)</description>
    ...
    <rules>
        <fullName>Enrollment App Threshold and Max Pool Calc p2</fullName>
        <actions>
            <name>Set_Threshold_GM_Snapshot_value</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>Adds the calculation to the results to the Threshold GM% Snapshot</description>
        <formula>OR(ThresholdGMSnapshot__c = 0, ThresholdGMSnapshot__c &lt;&gt;  ThresholdGM__c )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Notify Approvers and PM of EP being placed On Hold Status</fullName>
        <actions>
            <name>Send_Notification_to_EA_Approvers_when_status_set_to_On_Hold</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <description>WFR to fire based on the Enrollment Status field being set to On Hold</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Notify DTW Admin of Approver Change of Employment</fullName>
        <actions>
            <name>Alert_the_DTW_Admin_when_Approver_Employment_Status_is_Changed</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <formula>OR (
     NOT(ISPICKVAL( Approver1__r.Contact.Status__c , &quot;Active&quot;)),
     NOT(ISPICKVAL( Approver2__r.Contact.Status__c , &quot;Active&quot;)),
     NOT(ISPICKVAL( Approver3__r.Contact.Status__c , &quot;Active&quot;))
    )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Notify PM of Enrollment Plan Approved</fullName>
        <actions>
            <name>Send_Notification_to_EA_PM_when_EA_Status_is_Enrolled</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <description>WFR to fire based on the Enrollment Status field being set to Approved (Enrolled)</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Notify PM of Enrollment Plan Rejection</fullName>
        <actions>
            <name>Send_Notification_to_EA_PM_when_EA_Status_is_Rejected_by_DTW_Admin</name>
            <type>Alert</type>
        </actions>
        <active>true</active>
        <criteriaItems>
        ...
        <description>WFR to fire based on the Enrollment Status field being set to Rejected</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Notify for Baseline Shift</fullName>
        <actions>
